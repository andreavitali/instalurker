 ...
 */
  .directive('modalBackdrop', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
    return {
      restrict: 'EA',
      replace: true,
        template: '<div class="reveal-modal-bg fade" ng-class="{in: animate}" ng-click="close($event)" style="display: block"></div>',
  ...
  .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
    return {
      ...
      //templateUrl: 'template/modal/window.html',
        template: '<div tabindex="-1" class="reveal-modal fade {{ windowClass }}" ng-class="{in: animate}" style="display: block; visibility: visible"> <div ng-transclude></div></div>',
  ...
  .factory('$modalStack', ['$window', '$timeout', '$document', '$compile', '$rootScope', '$$stackedMap',
    function ($window, $timeout, $document, $compile, $rootScope, $$stackedMap) {
